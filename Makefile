...
# Generated by qmake (2.01a) (Qt 4.5.3) on: ?? 5? 19 10:37:21 2017
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/myEditTool1.0.0/ && $(COPY_FILE) --parents MyWidget.h .tmp/myEditTool1.0.0/ && $(COPY_FILE) --parents main.cpp MyWidget.cpp .tmp/myEditTool1.0.0/ && (cd `dirname .tmp/myEditTool1.0.0` && $(TAR) myEditTool1.0.0.tar myEditTool1.0.0 && $(COMPRESS) myEditTool1.0.0.tar) && $(MOVE) `dirname .tmp/myEditTool1.0.0`/myEditTool1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/myEditTool1.0.0
